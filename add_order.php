    ...
    <div class="container" id="body-content">
        ...
        <div class="order-form">
            ...
            <div class="section no-pad-bot" id="index-banner">
                <div class="container">
                    <br><br>
                    <h1 class="header center red-text">Coffee Shop Order Form</h1>
                ...
                <div class="col s10 offset-s1">
                    <div class="card red lighten-2">
                        <div class="card-content white-text">
                            <span class="card-title center-align">Add Orders Coffee</span>
                            <br>
                            <div class="row">
                                <form name="frmUser" method="post" action="" class="col s12">
                                    <div class="message black-text"><?php if (isset($message)) {
                                                                        echo $message;
                                                                    } ?></div>
                                    <br>
                                    <br>
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            ...
                                            <input name="name" id="name" type="text" class="demo-input-box" value="<?php echo $username; ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s12">
                                    ...
                                    <div class="row">
                                        <span class="card-title center-align">Menu</span>
                                        <?php
                                        include 'db.php';
                                        ...
                                        ?>
                                            <div class="col s12 l4">
                                                <div class="card hoverable">
                                                    ...
                                                    <a href="./insert_order.php?item=<?= $row['id_item']; ?>&member=<?= $_SESSION['id_member']; ?>">
                                                            <img src="images/menu/<?= $row['image']; ?>">
                                                            <span class="card-title"><strong><?= strtoupper($row['name']); ?></strong></span>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
